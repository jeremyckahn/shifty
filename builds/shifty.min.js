...
(function(c){function a(){return+new Date}function b(a,d){for(var g in a)a.hasOwnProperty(g)&&d(a,g)}function i(a,d){b(d,function(d,h){a[h]=d[h]});return a}function l(a,d){b(d,function(d,h){typeof a[h]==="undefined"&&(a[h]=d[h])});return a}function k(a,d,g){var h,a=(a-d.timestamp)/d.duration;for(h in g.current)g.current.hasOwnProperty(h)&&d.to.hasOwnProperty(h)&&(g.current[h]=d.originalState[h]+(d.to[h]-d.originalState[h])*(0,d.easingFunc)(a));return g.current}function j(a,d,g,h){var c;for(c=0;c<
d[a].length;c++)d[a][c].apply(g,h)}function m(a,d,g){b(c.Tweenable.prototype.filter,function(h,c){h[c][a]&&h[c][a].apply(d,g)})}function n(e,d){var g;g=a();g<e.timestamp+e.duration&&d.isAnimating?(d.loopId=setTimeout(function(){n(e,d)},1E3/e.owner.fps),m("beforeTween",e.owner,[d.current,e.originalState,e.to]),k(g,e,d),m("afterTween",e.owner,[d.current,e.originalState,e.to]),e.hook.step&&j("step",e.hook,e.owner,[d.current]),e.step.call(d.current)):e.owner.stop(true)}function f(a){a=a||{};this._hook=
{};this._tweenParams={owner:this,hook:this._hook,data:{}};this._state={};this._state.current=a.initialState||{};this.fps=a.fps||30;this.easing=a.easing||"linear";this.duration=a.duration||500;return this}f.prototype.tween=function(e,d,g,h,c){var b,f;if(!this._state.isAnimating)return b=this._tweenParams,f=this._state,this._state.loopId=0,this._state.pausedAtTime=null,d?(b.step=function(){},b.to=d||{},b.duration=g||this.duration,b.callback=h||function(){},b.easing=c||this.easing,f.current=e||{}):(b.step=
e.step||function(){},b.callback=e.callback||function(){},b.to=e.to||e.target||{},b.duration=e.duration||this.duration,b.easing=e.easing||this.easing,f.current=e.from||{}),b.timestamp=a(),b.easingFunc=this.formula[b.easing]||this.formula.linear,l(f.current,b.to),l(b.to,f.current),m("tweenCreated",b.owner,[f.current,b.originalState,b.to]),b.originalState=i({},f.current),f.isAnimating=true,this.resume(),e.start&&e.start(),this};f.prototype.to=function(a,d,g,h){typeof d==="undefined"?(a.from=this.get(),
this.tween(a)):this.tween(this.get(),a,d,g,h);return this};f.prototype.get=function(){return this._state.current};f.prototype.set=function(a){this._state.current=a||{};return this};f.prototype.stop=function(a){clearTimeout(this._state.loopId);this._state.isAnimating=false;a&&(i(this._state.current,this._tweenParams.to),m("afterTweenEnd",this,[this._state.current,this._tweenParams.originalState,this._tweenParams.to]),this._tweenParams.callback.call(this._state.current));return this};f.prototype.pause=
function(){clearTimeout(this._state.loopId);this._state.pausedAtTime=a();this._state.isPaused=true;return this};f.prototype.resume=function(){this._state.isPaused&&(this._tweenParams.timestamp+=a()-this._state.pausedAtTime);n(this._tweenParams,this._state);return this};f.prototype.hookAdd=function(a,d){this._hook.hasOwnProperty(a)||(this._hook[a]=[]);this._hook[a].push(d)};f.prototype.hookRemove=function(a,d){var g;if(this._hook.hasOwnProperty(a))if(d)for(g=this._hook[a].length;g>=0;g++)this._hook[a][g]===
d&&this._hook[a].splice(g,1);else this._hook[a]=[]};f.prototype.filter={};f.util={now:a,each:b,tweenProps:k,applyFilter:m,simpleCopy:i,weakCopy:l};f.prototype.formula={linear:function(a){return a}};if(typeof c.Tweenable==="undefined")c.Tweenable=f})(this);
