...
(function(a){if(a.Tweenable)a.Tweenable.util.interpolate=function(c,b,d,g){var e;if(c&&c.from)b=c.to,d=c.position,g=c.easing,c=c.from;e=a.Tweenable.util.simpleCopy({},c);a.Tweenable.util.applyFilter("beforeTween",e,[e,c,b]);d=a.Tweenable.util.tweenProps(d,{originalState:c,to:b,timestamp:0,duration:1,easingFunc:a.Tweenable.prototype.formula[g]||a.Tweenable.prototype.formula.linear},{current:e});a.Tweenable.util.applyFilter("afterTween",d,[d,c,b]);return d},a.Tweenable.prototype.interpolate=function(c,
b,d){c=a.Tweenable.util.interpolate(this.get(),c,b,d);this.set(c);return c}})(this);
