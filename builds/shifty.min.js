...
function g(a,b){var c,d,f;d=b.length;for(c=0;c<d;c++)f=a[b[c]].match(/(\d+)/g),a["__r__"+b[c]]=+f[0],a["__g__"+b[c]]=+f[1],a["__b__"+b[c]]=+f[2],delete a[b[c]]}function e(a,b){var c,d;d=b.length;for(c=0;c<d;c++)a[b[c]]="rgb("+parseInt(a["__r__"+b[c]],10)+","+parseInt(a["__g__"+b[c]],10)+","+parseInt(a["__b__"+b[c]],10)+")",delete a["__r__"+b[c]],delete a["__g__"+b[c]],delete a["__b__"+b[c]]}var h=/^#([0-9]|[a-f]){3}$/i,f=/^#([0-9]|[a-f]){6}$/i,j=/^rgb\(\s*\d+\s*,\s*\d+\s*,\s*\d+\s*\)\s*$/i,i;if(a.Tweenable)a.Tweenable.prototype.filter.color=
