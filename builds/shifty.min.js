...
this._tweenParams.owner,[this._state.current,this._tweenParams.originalState,this._tweenParams.to]),this._tweenParams.originalState=h({},this._state.current),this._state.isAnimating=!0,setTimeout(function(){n(e._tweenParams,e._state)},1E3/this.fps),this};this.to=function(a,d,f,g){typeof d==="undefined"?(a.from=this._state.current,this.tween(a)):this.tween(this._state.current,a,d,f,g);return this};this.get=function(){return this._state.current};this.set=function(a){this._state.current=a||{}};this.stop=
function(a){clearTimeout(this._state.loopId);this._state.isAnimating=!1;a&&(h(this._state.current,this._tweenParams.to),this._tweenParams.callback.call(this._state.current));return this};this.pause=function(){clearTimeout(this._state.loopId);this._state.pausedAtTime=a();this._state.isPaused=!0;return this};this.resume=function(){var a=this;this._state.isPaused&&(this._tweenParams.timestamp+=this._state.pausedAtTime-this._tweenParams.timestamp);setTimeout(function(){n(a._tweenParams,a._state)},1E3/
this.fps);return this};this.hookAdd=function(a,d){this._hook.hasOwnProperty(a)||(this._hook[a]=[]);this._hook[a].push(d)};this.hookRemove=function(a,d){var f;if(this._hook.hasOwnProperty(a))if(d)for(f=this._hook[a].length;f>=0;f++)this._hook[a][f]===d&&this._hook[a].splice(f,1);else this._hook[a]=[]};return this}m.prototype.filter={};m.util={now:a,each:e,tweenProps:j,applyFilter:l,simpleCopy:h};m.prototype.formula={linear:function(a){return a}};b.Tweenable=m})(this);
